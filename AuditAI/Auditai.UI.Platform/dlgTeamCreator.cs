...
public class dlgTeamCreator : C1RibbonForm
{
	...
	private async void btnConfirm_Click(object sender, EventArgs e)
	{
		...
		{
			Auditai.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "组织名称不允许为空");
			return;
		}
		if (txtTeamName.Text.Length > 50)
		{
			Auditai.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "组织名称不允许超过50个字符");
			return;
		}
		...
		case PlatformType.Custom:
			...
			break;
		default:
			Auditai.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "当前客户端类型未知，无法创建对应的组织!");
			return;
		}
