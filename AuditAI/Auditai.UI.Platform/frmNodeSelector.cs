...
public class frmNodeSelector : C1RibbonForm
{
	...
	{
		Text = "样式刷";
		base.Icon = Auditai.UI.Controls.Theme.SelectedAuditaiTheme.GetThemedIcon(Resources.TableStyleBrush);
	...
	private void PopulateShowHideCheck()
	{
		for (int i = _grid.Rows.Fixed; i < _grid.Rows.Count; i++)
		{
			...
			else if (_grid.Rows[i].UserData is Auditai.Model.TreeGroup)
			{
