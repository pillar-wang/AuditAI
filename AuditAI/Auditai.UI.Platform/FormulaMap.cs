...
public class FormulaMap : ISetTheme
{
	...
	public void Draw()
	{
		...
		_graph = Project.Current.FormulaManager.ToGraph(Theme.SelectedAuditaiTheme.ThemeContext.GradientColor, Theme.SelectedAuditaiTheme.ThemeContext.DarkColor, Program.MainForm.ProjectHierarchy.NumberShown);
