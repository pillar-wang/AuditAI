...
public class SplitContainerRibbonControlHost : RibbonControlHost, ISetTheme
{
	...
	{
		ValidationFormula.FlatAppearance.CheckedBackColor = Theme.SelectedAuditaiTheme.ThemeContext.TileColor;
		TableNote.FlatAppearance.CheckedBackColor = Theme.SelectedAuditaiTheme.ThemeContext.TileColor;
		TableFoot.FlatAppearance.CheckedBackColor = Theme.SelectedAuditaiTheme.ThemeContext.TileColor;
	}
