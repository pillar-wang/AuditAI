...
public class frmSelectProject : Form
{
    ...
    public Auditai.DTO.Project SelectedProject => _selectedProject;
    ...
    private async Task PopulateProjects()
    {
        ...
        try
        {
            IEnumerable<Auditai.DTO.Project> projects;
    ...
    {
        _selectedProject = e.Tag as Auditai.DTO.Project;
    ...
    {
        _selectedProject = _tileControl.SelectedTile?.Tag as Auditai.DTO.Project;
        if (_selectedProject != null)
        {
            this.DialogResult = DialogResult.OK;
            this.Close();
