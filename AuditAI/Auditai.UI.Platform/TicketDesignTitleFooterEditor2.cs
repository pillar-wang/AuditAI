...
public class TicketDesignTitleFooterEditor2
{
	...
	protected Auditai.Model.Table _table => _owner.Table;
	...
	private void _grid_BodyOwnerDrawCell(object sender, OwnerDrawCellEventArgs e)
	{
		...
		if (cell.HasFormula())
		{
			...
			try
			{
				FormulaReferenceModelResolver formulaReferenceModelResolver = new FormulaReferenceModelResolver(Auditai.Model.Project.Current);
	...
	private void Cmd_Popup_Field(object sender, EventArgs e)
	{
		...
		foreach (Auditai.Model.Column column in _table.Columns)
		{
			C1Command c1Command = new C1Command
			{
