...
public class User
{
	...
	public Auditai.DTO.Project GetNewProjectCandidate()
	{
		Auditai.DTO.Project project = new Auditai.DTO.Project();
		...
		project.Creator = new Auditai.DTO.User
		{
			Id = Id,
			Name = Name,
			UserName = UserName
		};
		project.Users = new Auditai.DTO.User[1]
		{
	...
	public Auditai.DTO.Project GetNewTemplateCandidate()
	{
		Auditai.DTO.Project project = new Auditai.DTO.Project();
		project.Id = Guid.NewGuid();
		project.ParentId = null;
