...
internal class CellListHashSetDictionary
{
	protected struct CacheData
	{
		public List<Cell> CheckValue;

		public HashSet<int> ValueResult;
	}
	...
	public bool Get(List<Cell> key, out HashSet<int> result)
	{
	...
	public void Add(List<Cell> key, HashSet<int> value)
	{
		if (_cacheCount == 10)
		{
