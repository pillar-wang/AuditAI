...
public class Project
{
	...
	public Dictionary<Auditai.DTO.User, UserRole> Users { get; set; }

	public Auditai.DTO.User Creator { get; set; }
	...
	public Project()
	{
		Users = new Dictionary<Auditai.DTO.User, UserRole>();
	...
	public void PopulateFieldsFromDto(Auditai.DTO.Project dto)
	{
		if (dto == null)
		{
			return;
		...
		if (dto.Users != null)
		{
			Users = dto.Users.ToDictionary((Auditai.DTO.User u) => u, (Auditai.DTO.User u) => u.Role);
		}
	...
	public void Load(TaskProgressValueReportCallback progressReportCallback = null)
	{
		...
		foreach (Auditai.DTO.ValidationFormula validationFormula in Dal.GetValidationFormulas())
		{
		...
		foreach (Auditai.DTO.FormatComplianceRule formatComplianceRule in Dal.GetFormatComplianceRules())
		{
		...
		foreach (Auditai.DTO.CrossDocumentValidationRule crossDto in Dal.GetCrossDocumentValidationRules())
		{
	...
	{
		if (!Current.Users.Any((KeyValuePair<Auditai.DTO.User, UserRole> kv) => kv.Key.Id == User.Current.Id))
		{
			return false;
		}
		if (Current.Users.First((KeyValuePair<Auditai.DTO.User, UserRole> kv) => kv.Key.Id == User.Current.Id).Value == UserRole.Manager || Current.Users.First((KeyValuePair<Auditai.DTO.User, UserRole> kv) => kv.Key.Id == User.Current.Id).Value == UserRole.Editor)
		{
			return true;
		}
		return false;
	...
	internal Auditai.DTO.Project ToDto()
	{
