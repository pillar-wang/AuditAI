...
public class ValidationFormula
{
	...
	internal Leqisoft.DTO.ValidationFormula ToDto()
	{
		return new Leqisoft.DTO.ValidationFormula
		{
			Dirty = Dirty,
			Id = Id,
			LeftExpr = LeftExpr,
	...
	internal static ValidationFormula FromDto(Leqisoft.DTO.ValidationFormula dto)
	{
