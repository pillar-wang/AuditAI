...
public class FormulaManagerTransitional
{
	...
	public void Load()
	{
		...
		foreach (Leqisoft.DTO.ValidationFormula validationFormula in _project.Dal.GetValidationFormulas())
		{
	...
	public void AddVf(Leqisoft.DTO.ValidationFormula vf)
	{
	...
	private List<FormulaRefInfo> GetVfRefs(Leqisoft.DTO.ValidationFormula vf, string leftOrRight)
	{
