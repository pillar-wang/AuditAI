...
public class FunctionEvaluator
{
	...
	public Operand RowCreator()
	{
		...
		KeyValuePair<Leqisoft.DTO.User, UserRole> keyValuePair = _env.RefEvalContext.Project.Users.FirstOrDefault((KeyValuePair<Leqisoft.DTO.User, UserRole> u) => u.Key.Id == createUserId);
		if (keyValuePair.Equals(default(KeyValuePair<Leqisoft.DTO.User, UserRole>)))
		{
			return StringOperand.Empty;
		}
	...
	public Operand GetName([ParameterName("文本参数")][Description("用户账号，数组型文本")] Operand userAccount)
	{
		...
		if (array.Length == 1)
		{
			...
			KeyValuePair<Leqisoft.DTO.User, UserRole> keyValuePair = _env.RefEvalContext.Project.Users.FirstOrDefault((KeyValuePair<Leqisoft.DTO.User, UserRole> u) => u.Key.UserName == account2);
			if (keyValuePair.Equals(default(KeyValuePair<Leqisoft.DTO.User, UserRole>)))
			{
				return StringOperand.Empty;
			}
		...
		for (int i = 0; i < array.Length; i++)
		{
			...
			KeyValuePair<Leqisoft.DTO.User, UserRole> keyValuePair2 = _env.RefEvalContext.Project.Users.FirstOrDefault((KeyValuePair<Leqisoft.DTO.User, UserRole> u) => u.Key.UserName == account);
			if (keyValuePair2.Equals(default(KeyValuePair<Leqisoft.DTO.User, UserRole>)))
			{
