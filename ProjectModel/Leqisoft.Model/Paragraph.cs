...
public class Paragraph : IIndexable
{
	...
	public static Paragraph FromDto(Leqisoft.DTO.Paragraph dto)
	{
	...
	public Leqisoft.DTO.Paragraph ToDto()
	{
		return new Leqisoft.DTO.Paragraph
		{
			Id = Id,
	...
	private string ReplaceIdInStream(string stream, Id64 replaceWith)
	{
		...
		if (xElement2 != null)
		{
			...
			if (text != null && LeqiBookmark.TryParse(text, out var lsbm))
			{
