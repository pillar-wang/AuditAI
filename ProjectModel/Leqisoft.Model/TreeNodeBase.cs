...
public abstract class TreeNodeBase
{
	...
	public bool HasSchemaPermission()
	{
		...
		if (!Project.Current.Users.Any((KeyValuePair<Leqisoft.DTO.User, UserRole> kv) => kv.Key.Id == User.Current.Id))
		{
			return false;
		}
		if (Project.Current.Users.First((KeyValuePair<Leqisoft.DTO.User, UserRole> kv) => kv.Key.Id == User.Current.Id).Value == UserRole.Manager)
		{
			return true;
		}
