...
public class CrossDocumentValidationRule
{
    ...
    internal Leqisoft.DTO.CrossDocumentValidationRule ToDto()
    {
        return new Leqisoft.DTO.CrossDocumentValidationRule
        {
            Id = Id,
    ...
    internal static CrossDocumentValidationRule FromDto(Leqisoft.DTO.CrossDocumentValidationRule dto)
    {
