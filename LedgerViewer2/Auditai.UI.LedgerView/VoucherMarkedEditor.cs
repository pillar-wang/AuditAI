...
public class VoucherMarkedEditor : ISetTheme
{
	...
	private void GrdVouchers_OwnerDrawCell(object sender, OwnerDrawCellEventArgs e)
	{
		...
		void DrawIconBackground(Rectangle rt)
		{
			...
			_adjustLevelIconOnFocusBackgroundBrush.Color = Auditai.UI.Controls.Util.DarkenColor(grdVouchers.Styles.SelectedColumnHeader.BackColor, 0.1);
	...
	private void InitComponent()
	{
		...
		Auditai.UI.Controls.Theme.SetCurrentTree(Tree);
