...
public class TrendencyEditor : ISetTheme
{
	...
	public void SetTheme()
	{
		...
		switch (Leqisoft.UI.Controls.Theme.SelectedLeqiTheme.Name)
		{
		case "leqi_Office2013LightGray":
	...
	private void GenerateChartByDay(DataTable dataSource)
	{
		...
		{
			exception.Log();
			Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "生成趋势图异常！");
		}
		finally
		{
	...
	private void GenerateTableByDay(DataTable dataSource)
	{
		...
		{
			exception.Log();
			Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "生成趋势表异常！");
		}
		finally
		{
			PendingAllEvent = false;
