...
#pragma warning restore CS0649
	...
	{
		base.Icon = Leqisoft.UI.Controls.Theme.SelectedLeqiTheme.GetThemedIcon(Resources.sideModifyBegin);
	...
	private bool ValidateData()
	{
		...
		if (num != num2)
		{
			Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, $"借贷金额不平衡,借方金额：{num}，贷方金额：{num2}");
			return false;
		}
		return true;
	}
	...
	private void InitializeComponent()
	{
		...
		this.cmdBalanceValidate.Image = Leqisoft.UI.LedgerView.Properties.Resources.balanceCheck;
		...
		this.cmdSaveData.Image = Leqisoft.UI.LedgerView.Properties.Resources.saveData;
