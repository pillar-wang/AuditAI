...
public class ReportPreview
{
	...
	private void ResetCurrentPrintSetting()
	{
		...
		double num3 = Table.Columns.Sum((Leqisoft.Model.Column col) => col.Visible ? col.Width : 0);
		double num4 = Table.Rows.Sum((Leqisoft.Model.Row row) => row.Visible ? row.Height : 0);
