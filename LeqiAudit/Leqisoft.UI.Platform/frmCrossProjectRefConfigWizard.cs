...
public class frmCrossProjectRefConfigWizard : Form  // 与 frmTableCollect2 一致
{
    ...
    private Panel _pnlStep3; // 选择填充方式与目标位置
    ...
    private void InitializeComponent()
    {
        ...
        string[] stepNames = { "选择项目", "选择表格", "填充方式与目标", "数据源范围" };
    ...
    private void ShowStep3()
    {
        try
        {
            var lbl = new Label { Text = "选择填充方式与目标位置", Font = _fontStepTitle, Dock = DockStyle.Top, Height = 35, TextAlign = ContentAlignment.BottomLeft, Padding = new Padding(5, 0, 0, 5) };
