...
internal class frmManageSnapshots : C1RibbonForm
{
	...
	private void _cmdDelete_Click(object sender, ClickEventArgs e)
	{
		...
		if (Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.Question, text, MessageBoxButtons.OKCancel) != DialogResult.Cancel)
		{
	...
	private void Populate()
	{
		...
		foreach (SnapshotInfo item in list)
		{
			...
			row["Size"] = Leqisoft.Model.Util.GetReadableFileSize(item.Size);
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Leqisoft.UI.Platform.frmManageSnapshots));
