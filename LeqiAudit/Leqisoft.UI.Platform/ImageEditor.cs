...
public class ImageEditor
{
	...
	public Leqisoft.Model.Image Image { get; set; }
	...
	public void Populate()
	{
		...
		{
			Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "显示图片过程发生异常，请稍候重试。异常信息：\n" + ex.Message);
		}
		catch (OutOfMemoryException)
		{
			Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "图片文件过大，暂时无法显示，请稍候重试。");
		}
		catch (FileNotFoundException)
		{
			Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "要打开的图片文件不存在。");
		}
		catch (UnauthorizedAccessException ex4)
		{
			Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "没有权限打开文件:" + ex4.Message);
			ex4.Log();
		}
	}
