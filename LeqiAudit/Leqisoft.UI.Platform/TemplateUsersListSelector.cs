...
public class TemplateUsersListSelector
{
	...
	private void AppendUserNode(User user, Node parentNode)
	{
		...
		System.Drawing.Image headPic = Leqisoft.UI.Controls.Util.GetHeadPic(user, 16, withManagerMark: true);
	...
	private void AppendGroupNode(UserGroup userGroup, Node parentNode)
	{
		...
		_grid.SetCellImage(row.Index, "UserName", Leqisoft.UI.Controls.Util.StandardImage(Resources.imgUserGroup, 16));
