...
public class frmAccessManage : C1RibbonForm
{
	...
	{
		base.Icon = Leqisoft.UI.Controls.Theme.SelectedLeqiTheme.GetThemedIcon(Resources.AccessControl);
	}
	...
	private void btnCertain_Click(object sender, EventArgs e)
	{
		...
		{
			Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "禁止修改，您没有权限执行该操作!");
	...
	private void GrdEditor_OwnerDrawCell(object sender, OwnerDrawCellEventArgs e)
	{
		...
		if (cellValue.Node.Key is Leqisoft.Model.TreeGroup || cellValue.Node.Key is TreeDirectoryNode)
		{
			e.Text = string.Empty;
			return;
		}
	...
	private Permissions GetGroupPermissions(Leqisoft.Model.TreeGroup g)
	{
	...
	public void Populate()
	{
		...
		_nameCache.Clear();
		editor.Items.Clear();
		editor.Items.Add(new Leqisoft.DTO.User
		{
			Id = 0L,
			Name = "全体成员"
		});
		foreach (Leqisoft.DTO.User item in Project.Users.Keys.Where((Leqisoft.DTO.User u) => u.Role != UserRole.Manager))
		{
	...
	private void InitializeComponent()
	{
		...
		this.picSearchIcon.Image = Leqisoft.UI.Platform.Properties.Resources.btnSearch;
