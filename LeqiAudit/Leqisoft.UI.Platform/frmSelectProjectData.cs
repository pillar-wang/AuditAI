...
public class frmSelectProjectData : C1RibbonForm
{
    ...
    private void _btnNext_Click(object sender, EventArgs e)
    {
        ...
        else if (_currentStep == 1)
        {
            ...
            {
                Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "请先选择一个表格");
                return;
            }
        }
    ...
    private void _btnOk_Click(object sender, EventArgs e)
    {
        ...
        switch (_mode)
        {
            ...
            case RefMode.FormulaCompute:
                ...
                {
                    Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "请选择一个列");
                    return;
                }
            ...
            case RefMode.ColumnRef:
                {
                    ...
                    if (selected.Count == 0)
                    {
                        Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "请至少选择一个列");
                        return;
                    }
            ...
            case RefMode.AreaRef:
                {
                    ...
                    {
                        Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "请输入有效的行号和列号（整数）");
                        return;
                    }
                    if (sr > er || sc > ec || sr < 0 || sc < 0)
                    {
                        Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "起始行列号必须 ≤ 结束行列号，且不能为负数");
                        return;
                    }
                    AreaStartRow = sr;
                    AreaEndRow = er;
