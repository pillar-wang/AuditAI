...
public class wechatLoginForm : C1RibbonForm
{
	...
	private void _browser_AddressChanged(object sender, AddressChangedEventArgs e)
	{
		...
		{
			if (e.Address.StartsWith("http://www.leqisoft.com/logintemp.html"))
			{
				try
				{
	...
	{
		base.Icon = Theme.SelectedLeqiTheme.GetThemedIcon(Resources.wechat_img);
	}
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Leqisoft.UI.Platform.wechatLoginForm));
