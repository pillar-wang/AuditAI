...
public class FormProjectMembers
{
	...
	private Leqisoft.UI.Platform.ListTileViewMode _Mode
	{
		get
		{
	...
	private async void _form_Load(object sender, EventArgs e)
	{
		...
		_form.Icon = Theme.SelectedLeqiTheme.GetThemedIcon(Resources.ProjectEditor);
		projectUsersTileSelector.SetTheme();
		_btnToggleMode.FlatStyle = FlatStyle.Flat;
		_btnToggleMode.FlatAppearance.BorderSize = 0;
		_ckbSearch.FlatAppearance.CheckedBackColor = Theme.SelectedLeqiTheme.ThemeContext.TileColor;
	...
	{
		IEnumerable<Leqisoft.DTO.User> users = (IEnumerable<Leqisoft.DTO.User>)((_Mode == Leqisoft.UI.Platform.ListTileViewMode.Tile) ? projectUsersTileSelector.ValidateAndGetUsers() : projectUsersListSelector.ValidateAndGetUsers());
		if (users == null)
		{
	...
	private void _btnToggleMode_Click(object sender, EventArgs e)
	{
		switch (_Mode)
		{
		case Leqisoft.UI.Platform.ListTileViewMode.List:
			ToMode(Leqisoft.UI.Platform.ListTileViewMode.Tile);
			_Mode = Leqisoft.UI.Platform.ListTileViewMode.Tile;
			break;
		case Leqisoft.UI.Platform.ListTileViewMode.Tile:
			ToMode(Leqisoft.UI.Platform.ListTileViewMode.List);
			_Mode = Leqisoft.UI.Platform.ListTileViewMode.List;
			break;
		}
	}
