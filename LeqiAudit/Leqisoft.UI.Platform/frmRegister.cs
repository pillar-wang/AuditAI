...
public class frmRegister : Form
{
	...
	private static Color _leqiMainColor = Color.FromArgb(0, 195, 245);

	private static Color _leqiMainColorButton = Color.FromArgb(0, 195, 245);
	...
	private void InitColor()
	{
		...
		btnRegister.BackColor = _leqiMainColorButton;
		btnGetValidateCode.BackColor = _leqiMainColorButton;
		radMale.RadioCircleMouseOverColor = _leqiMainColor;
		radMale.RadioCircleCheckedColor = _leqiMainColor;
		radFemale.RadioCircleMouseOverColor = _leqiMainColor;
		radFemale.RadioCircleCheckedColor = _leqiMainColor;
	}
	...
	private async void btnRegister_Click(object sender, EventArgs e)
	{
		...
		try
		{
			...
			{
				Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "用户名格式不正确，请至少包含一个字母！");
				return;
			}
			User user = new User
			{
			...
			if (user.Phone.Length == 0)
			{
				...
				{
					Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "验证码不正确！请重试");
					VerifyImg.Image = validateCreator.Create(out _identCode, VerifyImg.Width, VerifyImg.Height);
					return;
				}
				user.Phone = null;
			...
			else
			{
				if (!_getsms)
				{
					Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "绑定手机号需要先请求短信验证码");
					return;
				}
				if (!Regex.IsMatch(txtVerification.Text.Trim(), "^\\w+$"))
				{
					Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "验证码格式不正确！");
					return;
				}
			...
			Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "注册成功");
			Close();
		}
	...
	private async void btnGetValidateCode_Click(object sender, EventArgs e)
	{
		...
		try
		{
			if (ValidateAllText())
			{
				...
				{
					Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "用户名已存在！请直接登录或选择其他用户名");
					txtUserName.Focus();
					return;
				}
				if (await WebApiClient.PhoneExists(txtPhone.Text.Trim()))
				{
					Leqisoft.UI.Controls.MessageBox.Show(MessageBoxIcon.None, "手机号已注册！请直接登录或选择其他手机号");
					txtPhone.Focus();
					return;
				}
	...
	{
		System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Leqisoft.UI.Platform.frmRegister));
		this.txtUserName = new Leqisoft.UI.Controls.C1TextBoxEx();
		this.txtPassword = new Leqisoft.UI.Controls.C1TextBoxEx();
		this.txtPassword2 = new Leqisoft.UI.Controls.C1TextBoxEx();
		this.txtName = new Leqisoft.UI.Controls.C1TextBoxEx();
		this.txtEmail = new Leqisoft.UI.Controls.C1TextBoxEx();
		this.txtCompany = new Leqisoft.UI.Controls.C1TextBoxEx();
		this.txtPhone = new Leqisoft.UI.Controls.C1TextBoxEx();
		this.txtCity = new Leqisoft.UI.Controls.C1TextBoxEx();
		this.txtVerification = new Leqisoft.UI.Controls.C1TextBoxEx();
		this.btnRegister = new C1.Win.C1Input.C1Button();
		this.radMale = new Leqisoft.UI.Controls.WinformRadioButtonEx();
		this.radFemale = new Leqisoft.UI.Controls.WinformRadioButtonEx();
		...
		this.btnGetValidateCode = new Leqisoft.UI.Controls.TimerButton();
		...
		this.BackgroundImage = Leqisoft.UI.Platform.Properties.Resources.register;
