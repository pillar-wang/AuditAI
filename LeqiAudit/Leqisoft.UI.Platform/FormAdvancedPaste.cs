...
public class FormAdvancedPaste
{
	...
	private Leqisoft.Model.Column _srcMatchCol;

	private Leqisoft.Model.Column _dstMatchCol;

	public C1RibbonForm Form { get; }

	public Leqisoft.Model.Table SrcTable { get; set; }

	public Leqisoft.Model.Table DstTable { get; set; }

	public Leqisoft.Model.Column SrcCol { get; set; }

	public Leqisoft.Model.Column DstCol { get; set; }
	...
	public FormAdvancedPaste()
	{
		...
		Form.Icon = Theme.SelectedLeqiTheme.GetThemedIcon(Resources.Paste);
	...
	private void DrawRowNumber(Leqisoft.Model.Table table, C1FlexGridEx grid, OwnerDrawCellEventArgs e)
	{
	...
	private void DrawCell(Leqisoft.Model.Table table, C1FlexGridEx grid, OwnerDrawCellEventArgs e)
	{
	...
	{
		foreach (Leqisoft.Model.Column column in DstTable.Columns)
		{
			if (column != DstCol && column.HasFormula)
			{
				...
				Leqisoft.Model.Column fillSourceCol = formulaEvaluator.GetFillSourceCol(SrcTable);
	...
	private void PopulateTable(Leqisoft.Model.Table table, C1FlexGridEx grid, Leqisoft.Model.Column column)
	{
		grid.BeginUpdate();
	...
	public void PopulateColumns(Leqisoft.Model.Table table, C1FlexGridEx grid)
	{
	...
	private int GetRowCount(Leqisoft.Model.Table table)
	{
		return Math.Min(table.Rows.Count, 5);
	}

	private bool HasEllipseRow(Leqisoft.Model.Table table)
	{
