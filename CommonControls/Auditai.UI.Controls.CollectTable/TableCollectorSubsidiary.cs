...
{
	public TableCollectorSubsidiary(Ledger ledger, Auditai.Model.Table table)
		: base(ledger, table)
	{
	...
	public override TableCollectResult Collect(int auditYear)
	{
		...
		{
			if (base.IsSaveCollectResultByColumnId || base.Setting.Table.Columns.Any((Auditai.Model.Column c) => c.Id == new Id64(map.Key)))
			{
