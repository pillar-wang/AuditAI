...
#pragma warning restore CS0649
	...
	private event EventHandler<Leqisoft.Model.Column> _afterSelected;

	public event EventHandler<Leqisoft.Model.Column> AfterSelected
	{
		add
		{
	...
	{
		base.Icon = Theme.SelectedLeqiTheme.GetThemedIcon(Resources.SelectColumn);
	}
	...
	private void View_DoubleClick(object sender, EventArgs e)
	{
		...
		if (row2.UserData is Leqisoft.Model.Column column)
		{
	...
	private void _projectTree_TreeNodeClicked(object sender, TreeNodeEventArgs e)
	{
		...
		foreach (Leqisoft.Model.Column column in treeTableNode.Table.Columns)
		{
