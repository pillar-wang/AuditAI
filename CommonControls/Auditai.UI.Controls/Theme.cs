...
using Auditai.ThemeResource.Properties;
...
public static class Theme
{
	...
	private static AuditaiTheme _selectedAuditaiTheme;
	...
	public static AuditaiTheme SelectedAuditaiTheme
	{
		get
		{
			return _selectedAuditaiTheme ?? ThemePool[0];
		}
		set
		{
			_isAdapted = false;
	...
	public static Bitmap CurrentBackgroudImage
	{
		get
		{
			...
			Bitmap largeImage = SelectedAuditaiTheme.ThemeContext.LargeImage;
			if (_adaptImage != null)
			{
				_adaptImage.Dispose();
			}
	...
	static Theme()
	{
		...
		_isAdapted = false;
		ThemePool = new List<AuditaiTheme>();
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_Office2013LightGray, "auditai_Office2013LightGray", "AuditAI蓝", ThemeEnum.Typical, new ThemeContext
		{
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_Office2013Red, "auditai_Office2013Red", "墨染青", ThemeEnum.Typical, new ThemeContext
		{
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_Office2013Green, "auditai_Office2013Green", "春苔绿", ThemeEnum.Typical, new ThemeContext
		{
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_Office2016Blue, "auditai_Office2016Blue", "深空蓝", ThemeEnum.Typical | ThemeEnum.WhiteIcon, new ThemeContext
		{
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_Office2016Red, "auditai_Office2016Red", "琥珀红", ThemeEnum.Typical | ThemeEnum.WhiteIcon, new ThemeContext
		{
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_Office2016Green, "auditai_Office2016Green", "翡翠绿", ThemeEnum.Typical | ThemeEnum.WhiteIcon, new ThemeContext
		{
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_VS2013Blue, "auditai_VS2013Blue", "宝石蓝", ThemeEnum.Typical, new ThemeContext
		{
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_VS2013Light, "auditai_VS2013Light", "铂金银", ThemeEnum.Typical, new ThemeContext
		{
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_VS2013Tan, "auditai_VS2013Tan", "温暖棕", ThemeEnum.Typical, new ThemeContext
		{
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_VS2013Red, "auditai_VS2013Red", "深酒红", ThemeEnum.Typical, new ThemeContext
		{
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_VS2013Green, "auditai_VS2013Green", "清新绿", ThemeEnum.Typical, new ThemeContext
		{
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_VS2013Purple, "auditai_VS2013Purple", "魅惑紫", ThemeEnum.Typical, new ThemeContext
		{
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_VS2013Blue, "auditai_VS2013Blue", "流光蓝", ThemeEnum.Typical | ThemeEnum.Picture, new ThemeContext
		{
			GradientColor = Color.FromArgb(207, 214, 229),
			TileColor = Color.FromArgb(191, 222, 227),
			LargeImage = Auditai.UI.Controls.Properties.Resource1.BluePic,
			SmallImage = Auditai.UI.Controls.Properties.Resource1.smlBluePic,
			BackColor = Color.FromArgb(214, 219, 233),
			LineColor = Color.FromArgb(77, 96, 130),
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_VS2013Light, "auditai_VS2013Light", "炫动银", ThemeEnum.Typical | ThemeEnum.Picture, new ThemeContext
		{
			GradientColor = Color.FromArgb(184, 202, 229),
			TileColor = Color.FromArgb(208, 208, 208),
			LargeImage = Auditai.UI.Controls.Properties.Resource1.LightPic,
			SmallImage = Auditai.UI.Controls.Properties.Resource1.smlLightPic,
			BackColor = Color.FromArgb(238, 238, 242),
			LineColor = Color.FromArgb(224, 224, 224),
			DarkColor = Color.FromArgb(72, 97, 140),
			BulletColor = Color.FromArgb(40, 131, 243),
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_VS2013Tan, "auditai_VS2013Tan", "灯光橙", ThemeEnum.Typical | ThemeEnum.Picture, new ThemeContext
		{
			GradientColor = Color.FromArgb(255, 240, 208),
			TileColor = Color.FromArgb(243, 224, 184),
			LargeImage = Auditai.UI.Controls.Properties.Resource1.OrangePic,
			SmallImage = Auditai.UI.Controls.Properties.Resource1.smlOrangePic,
			BackColor = Color.FromArgb(226, 220, 202),
			LineColor = Color.FromArgb(116, 105, 75),
			DarkColor = Color.FromArgb(116, 105, 75),
			BulletColor = Color.FromArgb(255, 116, 105, 75),
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_VS2013Red, "auditai_VS2013Red", "圣诞红", ThemeEnum.Typical | ThemeEnum.Picture, new ThemeContext
		{
			GradientColor = Color.FromArgb(226, 202, 202),
			TileColor = Color.FromArgb(255, 194, 218),
			LargeImage = Auditai.UI.Controls.Properties.Resource1.RedPic2,
			SmallImage = Auditai.UI.Controls.Properties.Resource1.smlRedPic2,
			BackColor = Color.FromArgb(226, 202, 202),
			LineColor = Color.FromArgb(116, 75, 75),
			DarkColor = Color.FromArgb(116, 75, 75),
			BulletColor = Color.FromArgb(116, 75, 75),
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_VS2013Green, "auditai_VS2013Green", "田野绿", ThemeEnum.Typical | ThemeEnum.Picture, new ThemeContext
		{
			GradientColor = Color.FromArgb(217, 228, 218),
			TileColor = Color.FromArgb(190, 219, 161),
			LargeImage = Auditai.UI.Controls.Properties.Resource1.GreenPic,
			SmallImage = Auditai.UI.Controls.Properties.Resource1.smlGreenPic,
			BackColor = Color.FromArgb(207, 221, 208),
			LineColor = Color.FromArgb(87, 120, 90),
			DarkColor = Color.FromArgb(87, 120, 90),
			BulletColor = Color.FromArgb(87, 120, 90),
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_VS2013Purple, "auditai_VS2013Purple", "花香紫", ThemeEnum.Typical | ThemeEnum.Picture, new ThemeContext
		{
			GradientColor = Color.FromArgb(210, 201, 225),
			TileColor = Color.FromArgb(255, 245, 253),
			LargeImage = Auditai.UI.Controls.Properties.Resource1.RedPic,
			SmallImage = Auditai.UI.Controls.Properties.Resource1.smlRedPic,
			BackColor = Color.FromArgb(211, 202, 226),
			LineColor = Color.FromArgb(110, 89, 150),
			DarkColor = Color.FromArgb(110, 89, 150),
			BulletColor = Color.FromArgb(110, 89, 150),
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_MacBlue, "auditai_MacBlue", "苹果蓝", ThemeEnum.Typical, new ThemeContext
		{
		...
		RegisterTheme(Auditai.ThemeResource.Properties.Resource1.auditai_MacSilver, "auditai_MacSilver", "苹果银", ThemeEnum.Typical, new ThemeContext
		{
			GradientColor = Color.FromArgb(187, 204, 216),
	...
	public static void SelectedThemeById(string themeId)
	{
		...
		SelectedAuditaiTheme = ThemePool.Find((AuditaiTheme t) => t.Id == themeId);
		ResetTableTicketViewModelPanelThemeContext(SelectedAuditaiTheme.FriendName);
		ResetOutBarPageMoreMenuImageContext(SelectedAuditaiTheme.FriendName);
		ResetGridMoreMenuImageContext(SelectedAuditaiTheme.FriendName);
	}
	...
	{
		C1ThemeController.ApplyThemeToObject(control, SelectedAuditaiTheme.GetC1Theme());
	}
	...
	{
		AuditaiTheme item = new AuditaiTheme
		{
	...
	private static void ResetTableTicketViewModelPanelThemeContext(string themeName)
	{
		...
		SelectedAuditaiTheme.ThemeContext.TableTicketViewModePanelContext = tableTicketViewModeThemeContext;
		tableTicketViewModeThemeContext.HotBackColor = SelectedAuditaiTheme.GetBackgroundSolidColor("C1Command\\C1ToolBar\\Button\\Hot\\Background");
		tableTicketViewModeThemeContext.HotForeColor = SelectedAuditaiTheme.GetC1Theme().GetColor("C1Command\\C1OutBar\\Page\\Title\\Default\\ForeColor");
		...
		if ((uint)c <= 28201u)
		{
			...
			case '深':
				if (!(themeName == "深酒红"))
				{
					if (themeName == "深空蓝")
					{
						tableTicketViewModeThemeContext.HotBackColor = SelectedAuditaiTheme.GetBackgroundSolidColor("C1FlexGrid\\Styles\\Highlight\\Background");
						tableTicketViewModeThemeContext.CheckedBackColor = tableTicketViewModeThemeContext.HotBackColor;
						tableTicketViewModeThemeContext.CheckedForeColor = SelectedAuditaiTheme.GetC1Theme().GetColor("C1FlexGrid\\Styles\\Normal\\ForeColor");
		...
		tableTicketViewModeThemeContext.CheckedForeColor = SelectedAuditaiTheme.GetC1Theme().GetColor("BaseThemeProperties\\Styles\\Content\\ForeColor");
		tableTicketViewModeThemeContext.HotForeColor = tableTicketViewModeThemeContext.CheckedForeColor;
		return;
		IL_023d:
		tableTicketViewModeThemeContext.HotBackColor = SelectedAuditaiTheme.GetBackgroundSolidColor("C1FlexGrid\\Styles\\Highlight\\Background");
		tableTicketViewModeThemeContext.CheckedBackColor = tableTicketViewModeThemeContext.HotBackColor;
		tableTicketViewModeThemeContext.CheckedForeColor = SelectedAuditaiTheme.GetC1Theme().GetColor("C1FlexGrid\\Styles\\Highlight\\ForeColor");
		tableTicketViewModeThemeContext.HotForeColor = tableTicketViewModeThemeContext.CheckedForeColor;
	}
	...
	private static void ResetOutBarPageMoreMenuImageContext(string themeName)
	{
		...
		case "宝石蓝":
		case "流光蓝":
			SelectedAuditaiTheme.ThemeContext.OutBarPageMoreMenuImageIndex = OutBarPageMoreMenuImageIndex.White;
			break;
		default:
			SelectedAuditaiTheme.ThemeContext.OutBarPageMoreMenuImageIndex = OutBarPageMoreMenuImageIndex.Default;
			break;
		}
	}
	...
	private static void ResetGridMoreMenuImageContext(string themeName)
	{
		...
		case "苹果蓝":
		case "苹果银":
			SelectedAuditaiTheme.ThemeContext.GridMoreMenuImageIndexOnHighLightRow = GridMoreMenuImageIndex.White;
			break;
		default:
			SelectedAuditaiTheme.ThemeContext.GridMoreMenuImageIndexOnHighLightRow = GridMoreMenuImageIndex.Default;
			break;
		}
	}
}
