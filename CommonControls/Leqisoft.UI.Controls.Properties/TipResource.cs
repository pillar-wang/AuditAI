...
public static class TipResource
{
	...
	public static string 合并设置按钮 = "跨项目汇总数据设置功能说明[|]跨项目汇总数据设置用于指定当前表格做为合并汇总表，并指定当前表由子公司哪些表格进行合并汇总而来。在跨项目汇总数据设置时，您需指定当前表格的分组填充列和汇总填充列，并选择各子公司的汇总表格、分组列和汇总列。";

	public static string 合并报表按钮 = "跨项目汇总数据结果功能说明[|]跨项目汇总数据结果用于将子公司相关表格数据自动汇总合并至当前表格，前提是您需要先进行“跨项目汇总数据设置”操作，将合并子" + StringConstBase.Current.Project + "范围、各子" + StringConstBase.Current.Project + "表格、各表格分组列和汇总列提前配置好后，即可实现“一键合并报表”。";
